...
$sql = "SELECT * FROM matchclub 
        WHERE WEEK(DATE_ADD(temp_debut, INTERVAL 7 DAY), 1) = WEEK(DATE_ADD(NOW(), INTERVAL 7 DAY), 1) 
        AND WEEK(DATE_ADD(temp_fin, INTERVAL 7 DAY), 1) = WEEK(DATE_ADD(NOW(), INTERVAL 7 DAY), 1) 
        ...
        <main>
            <ul class="box-info">
                <li>
                    <i class='' ></i>
					<span class="text">
                        <div class="btn col-md-6"><a href="calenderNext.php?week=<?php echo date('W', strtotime('last week')); ?>">Précédente</a></div>
                    </span>
                    </li>
                    <li>
                        <i class='' ></i>
